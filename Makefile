...
SRC:=$(GOPATH)/src/github.com/DaniilMogilevkin/reporter
...
.PHONY: build
build: 
	go install -v github.com/DaniilMogilevkin/reporter/cmd/grafana-reporter

.PHONY: buildlinux 
buildlinux: 	
	cmd //v //c "set GOOS=linux&&go install -v github.com/DaniilMogilevkin/reporter/cmd/grafana-reporter"
